...
function writeGetUrlInfo()
{
	...
	$requestInformation = 'http://'.$_SERVER['HTTP_HOST'].htmlentities($_SERVER['PHP_SELF']).'?'.$_SERVER['QUERY_STRING']."\n";
	$db->exec('INSERT INTO `apilog`(`remode_addr`, `http_user_agent`, `http_req`) VALUES(?,?,?);', $_SERVER['REMOTE_ADDR'], $_SERVER['HTTP_USER_AGENT'],$requestInformation);
}
